                        ...
                        fixed(short* pcolors = colors)
                        {
                            ...
                            for (int j = 0; j < m_dimensions.y; j++)
                            {
                                ...
                                for (int i = 0; i < m_dimensions.x; i++)
                                {
                                    ...
                                    {
                                        float[][] partialRes = new float[][]{localState.partialResT1, localState.partialResT1};
                                        ...
                                        for(int p = 0; p < 2; p++)
                                        {
                                            ...
                                            {
                                                if (gradient != null)
                                                    partialRes[p][partialRes.Length - 1] = gradient.Values[times[p]][readInd]; //In case we need the gradient
                                                else
                                                    partialRes[p][partialRes.Length - 1] = 0.0f;
                                            }
                                        }
